//here we have coppied the entire singlylinked list program and made it work for stacks without changing the functioning of any of the functions
#include<stdio.h>
#include<stdlib.h>
